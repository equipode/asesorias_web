...
<head>
    ...
    <meta content="" name="description"
        content="Nuestros paquetes te ayudan a empreder y a tener exito con tu sitio web">
    ...
    <div class="container">
        <div class="row">
            <div align="center" class="col-md-4">
                ...
                <a href="detalle_paquetes.php" class="btn btn-primary rounded-pill py-3 px-5 animated slidenlnLeft"
                    title="paquete basico">Detalles</a>
            </div><br>
            <div align="center" class="col-md-4">
                <img src="img/popular.png" class="d-block w-100" alt="..." width="300" height="700">
                <a href="detalle_paquetes.php" class="btn btn-primary rounded-pill py-3 px-5 animated slidenlnLeft"
                    title="paquete popular">Detalles</a>
            </div><br>
            <div align="center" class="col-md-4">
                <img src="img/modern.png" class="d-block w-100" alt="..." width="300" height="700">
                <a href="detalle_paquetes.php" class="btn btn-primary rounded-pill py-3 px-5 animated slidenlnLeft"
                    title="paquete modern">Detalles</a>
            </div><br>
        </div>
    </div><br><br>
        ...
        <div class="row">
            <div class="col-md-6">
                <ul align="justify">
                    ...
                    <li>En caso de agregar detalles adicionales a las páginas, avisar con anticipación y debe a hacer
                        otro depósito además del acordado</li>
                </ul>
            </div>
