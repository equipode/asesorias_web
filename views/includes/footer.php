    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                <img src="img/logo.png" class="d-block w-100" alt="..." width="300" height="90"><br>
                <h5 class="text-white mb-4">Asesorías sitios web</h5>
            ...
            <div  class="col-lg-3 col-md-6">
                ...
                <ul align="justify">
                    <li>Asesoramiento para actualizar sitios web</li>
                    <li>Te capacitamos para dar un mejor manejo de tu sitio web</li>
                    <li>Creamos todo tipo de sitio web</li>
                    <li>Le brindamos protección a tu sitio web</li>
                    <li>Enlazamos tu sitio web con aliados estrátegicos</li>
                </ul>
            </div>
            <div class="col-lg-3 col-md-6">
                <h5 class="text-white mb-4" align="center">Trabajo</h5>
                <ul align="justify">
                    <li>Afiliados</li>
                    <li>Ofrecemos servicios</li>
                    <li>Ofertas</li>
                    <li>Promociones</li>
                </ul>
            </div>
        ...
        <div class="copyright">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0" >
                    &copy; <a href="#">Asesorías sitios web</a>, All Right Reserved.
                </div>
            </div>
        </div>
    </div>
